...
└── skills/                       # Специализированные навыки
    ...
    ├── deploy-and-test/         # Развертывание и тестирование (/deploy-and-test)
...
Навыки - углубленные руководства и инструменты для специфических задач. Полный гайд по dispatch - [`.claude/skills_instructions.md`](.claude/skills_instructions.md). Навыки с пометкой `/command` можно вызывать как слэш-команды.
...
| **/deploy-and-test** | Развертывание конфигурации в тестовую базу и тестирование через веб-клиент |
