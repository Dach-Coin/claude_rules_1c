...
Набор локальных скиллов - blanket-импорт из [comol/cc-1c-skills](https://github.com/comol/cc-1c-skills)@f5dd677. Проектная доработка поверх upstream - параметризация `PLATFORM_PATH` в PS1-скриптах и собственная карта знаний `.claude/1c-metadata-manage.md`.
