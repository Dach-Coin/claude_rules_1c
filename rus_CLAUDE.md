...
- `bsl-form-module-standards` - стандарты модулей управляемых форм: обязательные регионы, директивы компиляции, клиент-серверное взаимодействие, добавление обработчиков событий (с регистрацией в `Form.xml`), модификация типовых форм, условное оформление. Используется при написании или правке `Form.Module.bsl`.
