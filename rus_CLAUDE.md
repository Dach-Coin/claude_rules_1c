...
- Типографика репозитория: не использовать em-dash, en-dash и букву `ё`/`Ё` нигде - только обычный ASCII `-` и `е`/`Е`. См. `.claude/rules/dev-standards-core.md` § Repository Typography.
