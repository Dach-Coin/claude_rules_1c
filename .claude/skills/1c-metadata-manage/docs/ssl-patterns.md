...
For basic SSL usage (attribute access, user messages) — see `project_rules.md`.
...
2. **Check existing patterns** — use `search_code` to find how similar tasks are solved in the codebase
