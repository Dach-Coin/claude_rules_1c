...
- **Маркеров нет** (нейтральный «привет», «помоги», «начнем» и т.п.) - перечисляю **весь** каталог из манифеста (имя + одна строка описания на профиль) + опцию `core only`, без ранжирования, и прошу уточнить задачу. Не угадываю топ-3, потому что без маркеров любая тройка отрежет реально нужный профиль.
