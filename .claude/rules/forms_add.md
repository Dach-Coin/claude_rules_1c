...
## To generate new form:
   ...
   Step 4: use **1c-metadata-manage** skill to compile the form from JSON and validate
...
## To modify existing form:
  ...
  - use **1c-metadata-manage** skill (form-edit, form-validate) for actual modifications
